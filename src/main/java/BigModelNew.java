...
public class BigModelNew extends WebSocketListener {
    ...
    public static final String appid = "cdf63b11";
    //必须填写，讯飞开发平台自己申请。
    public static final String apiSecret = "ODJiOGM1Y2Y3OGI0M2E1ZGUxMzI3ZDMz";
    //必须填写，讯飞开发平台自己申请。
    public static final String apiKey = "dc10a03288b244fb25fc24d6a62738ee";
    ...
    public  String getAnswer(String queestion) throws Exception {
        totalFlag=false;
        NewQuestion=queestion;
        // 构建鉴权url
